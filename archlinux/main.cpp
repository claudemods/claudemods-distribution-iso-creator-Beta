...
private:
    ...
    bool install_base_packages(const std::string& desktop_packages, const std::string& display_manager = "") {
        ...
        std::string packages = "base base-devel calamares-fix dosfstools mtools rsync parted linux-firmware grub efibootmgr os-prober sudo arch-install-scripts mkinitcpio vim nano bash-completion systemd networkmanager " + selected_kernel;
