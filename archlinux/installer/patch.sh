...
if [[ "$DISTRO" == "arch" || "$DISTRO" == "cachyos" ]]; then
    ...
    run_command_cyan "cd /home/$USER/claudemods-distribution-iso-creator-Beta/archlinux/updater && g++ -std=c++23 main.cpp -o updater.bin"
    print_status "Installing"
    run_command_cyan "cd /home/$USER/claudemods-distribution-iso-creator-Beta/archlinux/updater && ./updater.bin"
    else
