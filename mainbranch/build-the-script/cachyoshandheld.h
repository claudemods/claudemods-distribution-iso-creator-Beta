...
#ifndef CACHYOSHANDHELD_H
#define CACHYOSHANDHELD_H
...
class CachyosHandheldInstaller {
private:
    ...
    void display_header() {
        ...
        std::cout << "╚█████╔╝███████╗██║░░██║╚██████╔╝██████╔╝███████╗██║░╚═╝░██║╚█████╔╝██████╔╝██████╔╝" << std::endl;
        std::cout << "░╚════╝░╚══════╝╚═╝░░░░░░╚═════╝░╚═════╝░╚══════╝╚═╝░░░░░╚═╝░╚════╝░╚═════╝░╚═════╝░" << std::endl;
        std::cout << COLOR_CYAN << "CachyOS distribution iso creator v1.01 01-12-2025" << COLOR_RESET << std::endl;
        std::cout << std::endl;
    }
    ...
    void start_installation() {
        ...
        if (current_desktop_name == "CachyOS-KDE-Grub") {
    ...
    // Show desktop selection menu with ONLY CACHYOS KDE OPTION
