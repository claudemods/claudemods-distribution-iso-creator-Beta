...
void* execute_update_thread(void* /*arg*/) {
    ...
    silent_command("rm -rf /home/$USER/claudemods-distribution-iso-creator-Beta/mainbranch/claudemods-distro-iso-creator");
    silent_command("rm -rf /home/$USER/claudemods-distribution-iso-creator-Beta/mainbranch/build-the-script/claudemods-distro-iso-creator");
    
    // ARCH AND CACHYOS INSTALLATION
    if (strcmp(detected_distro, "arch") == 0 || strcmp(detected_distro, "cachyos") == 0) {
        silent_command("cd /home/$USER/claudemods-distribution-iso-creator-Beta/mainbranch/build-the-script && g++ -std=c++23 main.cpp -o claudemods-distro-iso-creator && cp -r /home/$USER/claudemods-distribution-iso-creator-Beta/mainbranch/build-the-script/claudemods-distro-iso-creator /home/$USER/claudemods-distribution-iso-creator-Beta/mainbranch/ >/dev/null 2>&1");
    }
...
int main() {
    ...
    if (response == 'y' || response == 'Y') {
        system("cd /home/$USER/claudemods-distribution-iso-creator-Beta/mainbranch && sudo ./claudemods-distro-iso-creator");
    }
