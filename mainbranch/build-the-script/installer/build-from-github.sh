...
if [[ "$DISTRO" == "arch" || "$DISTRO" == "cachyos" ]]; then
    ...
    print_status "claudemods distribution iso creator Beta v1.01 17-05-2026"
    ...
    run_command_cyan "cd /home/$USER/claudemods-distribution-iso-creator-Beta/mainbranch/build-the-script/updater && g++ -std=c++23 main.cpp -o updater.bin"
    print_status "Installing"
    run_command_cyan "cd /home/$USER/claudemods-distribution-iso-creator-Beta/mainbranch/build-the-script/updater && ./updater.bin"
    else
