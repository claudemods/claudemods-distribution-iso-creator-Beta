...
new claudemods distribution creator iso is out this for installing my distribution options i provide using a 700mb custom iso
...
- im now going to build s script for use in a custom iso to setup and install the options provided
...
- cachyos repos are current causing issues with my script since packages in their repos are corrupt
  i cannot fix without adding working packages to my own repo which i have no means todo sorry
  minimal editions of claudemods distributions work fine just not minimal dev or full editions
  once the repos are fixed i will update please wait
...
currently im talking to some kde devs to help resolve show hidden files in dolphin since i want to save this manually with a command or config file as it currently doesnt work evan with saved user files in my .zips but will save if you do it manually after calamares installation within dolphins view menu
...
## changlelog claudemods distributions v1.01 21-01-2026 20:05pm GMT (uk time)
- system icon fixes to spitfire black edition full and full dev
...
## changlelog claudemods distributions v1.01 08-01-2026
- many things updated in the script e.g wireless-regdom and 80-gamecompatibility.conf
- spitfire full edition .zips have been updated
- spitfire black edition .zip added to my website but script needs to be updated to use it
...
## v1.0 - 13-01-2026 19:02PM GMT (UK time)
- all distros install fine after tests no changes needed
