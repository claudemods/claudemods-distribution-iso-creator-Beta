...
Item {
    ...
    MouseArea {
        ...
        DropShadow {
            ...
            samples: 14
            spread: 0.3
            color : "#24ffff" // shadows should always be black
            Behavior on opacity {
                OpacityAnimator {
        ...
        QQC2.StackView {
            ...
            initialItem: Login {
                ...
                actionItems: [
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/SpitFireLogin/assets/suspend.svg"
                    ...
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/SpitFireLogin/assets/restart.svg"
                    ...
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/SpitFireLogin/assets/shutdown.svg"
                    ...
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/SpitFireLogin/assets/change_user.svg"
